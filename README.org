...
** Usage
   ...
   The package offers several commands which can be accessed through a popup menu. Use the shortcut ~C-c t w~ to open the Playwright command popup. Available commands include:
